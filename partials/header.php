          ...
          <section id="formRicerca" class="formInvisible">
            <form action="list.php" method="GET">
              <div class="input-group">
                <input type="text" class="form-control" autocomplete="off" placeholder="Inserisci il nome da cercare" aria-label="Recipient's username"
                       name="textToSearch" id="textToSearch" aria-describedby="button-addon2">
